...
namespace codac
{
  ...
  void Solver::set_stopping_mode(int stopping_mode)
  {
   ...
   void Solver::set_fixpoint_mode(int fixpoint_mode)
  {
    m_fixpoint_mode=fixpoint_mode;
  }
  ...
  double Solver::one_finite_gate(const TubeVector &x){
    ...
    throw codac::Exception (" solver " , "solver unable to bisect ");
  }
