...
#ifndef __CODAC_SOLVER_H__
#define __CODAC_SOLVER_H__
...
namespace codac
{
  ...
  public:
      ...
      */
      ...
      void set_fixpoint_mode(int fixpoint_mode) ; // 0 for tube volume , 1 for extreme gates diam sum ,
